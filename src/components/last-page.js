    ...
    return (
        <div>
            <Sidebar ><br /><br />
                ...
                <div className="mx-auto w-10/12 flex flex-col sm:flex-row justify-between py-2 sm:py-4 sm:px-4 lg:px-6 border border-gray-300 shadow-lg rounded-lg bg-white">
                <div className="sm: p-8">
                    <div>
                        <h1 className="text-red-500 font-semibold text-2xl">Attention!</h1>
                        <p className="font-semibold text-lg">You have filled your application. Do you want to submit?</p>
                    </div>
                    </div>
                    <div className="mt-11">
                        <Button className="w-full sm:w-60 rounded-lg bg-blue-900 text-white py-2 sm:py-2 px-2" htmlType="submit">
                            Submit
                        </Button>
                    </div>
